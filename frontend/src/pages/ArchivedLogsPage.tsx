...
const useArchivedLogsListQuery = createDataHook<
  ApiArchivedLogsFilters,
  PaginatedResponse<ArchivedLog>
>({
  ...
  const filtersPanel = (
    <>
      ...
      <FilterField
        ...
        htmlFor="archived-logs-filter-application"
      >
        <Select
      ...
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        ...
        {archivedLogsQuery.isError && errorMessage && (
          <Alert tone="danger" className="mt-4">
            {t('listLoadError', { message: errorMessage })}
          </Alert>
        )}
