...
/**
 * Asignaciones usuario ↔ tipo de estudio (FDW global, sin FK al catálogo
 * `study_types` porque esta app no proyecta la jerarquía completa — solo
 * necesita los IDs para `/me`).
 */
