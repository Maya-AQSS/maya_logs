...
return [
    ...
    // Telemetría maya_authorization → maya.logs (app slug maya-authorization, application_id 3)
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-004',
        'name' => 'Application regenerate API key failed',
        'description' => 'Fallo al regenerar la clave API de una aplicación o al registrar la auditoría asociada.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-005',
        'name' => 'Role create failed',
        'description' => 'Fallo al crear un rol desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-006',
        'name' => 'Role update failed',
        'description' => 'Fallo al actualizar un rol desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-007',
        'name' => 'Role delete failed',
        'description' => 'Fallo al eliminar un rol desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-008',
        'name' => 'Role sync permissions failed',
        'description' => 'Fallo al sincronizar los permisos de un rol desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-009',
        'name' => 'Role assign to user failed',
        'description' => 'Fallo al asignar un rol a un usuario desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-010',
        'name' => 'Role revoke from user failed',
        'description' => 'Fallo al revocar un rol de un usuario desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-011',
        'name' => 'Permission create failed',
        'description' => 'Fallo al crear un permiso desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-012',
        'name' => 'Permission update failed',
        'description' => 'Fallo al actualizar un permiso desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-013',
        'name' => 'Permission delete failed',
        'description' => 'Fallo al eliminar un permiso desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-014',
        'name' => 'Permission set user override failed',
        'description' => 'Fallo al establecer un override grant/deny de permiso para un usuario.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-015',
        'name' => 'Permission remove user override failed',
        'description' => 'Fallo al eliminar un override de permiso de un usuario.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-016',
        'name' => 'Authorization cache invalidate failed',
        'description' => 'Fallo al invalidar la caché de permisos de un usuario tras una mutación del panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-017',
        'name' => 'Authorization cache batch invalidate failed',
        'description' => 'Fallo al invalidar la caché de permisos de varios usuarios en lote.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-018',
        'name' => 'Accessible apps resolution failed',
        'description' => 'Fallo al resolver las aplicaciones accesibles de un usuario (consultas o caché).',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-019',
        'name' => 'Permissions resolution failed',
        'description' => 'Fallo al resolver permisos efectivos de un usuario en una aplicación (consultas o caché).',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-020',
